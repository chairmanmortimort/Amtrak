...
include(":examples:cdta")
project(":examples:cdta").projectDir = file("examples/cdta")

include(":examples:wikipedia")
project(":examples:wikipedia").projectDir = file("examples/wikipedia")
